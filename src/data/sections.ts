...
モンステラは、サトイモ科モンステラ属に分類される常緑のつる性着生植物で、学名を **Monstera deliciosa**（モンステラ・デリシオーサ）といいます。原産地は **中米（メキシコ南部からパナマにかけて）の熱帯雨林** で、野生下では大木の幹や湿った岩肌に **気根** を絡めながら、光を求めて上方へとよじ登るように生長します。後に世界各地の熱帯・暖地に導入され、ポルトガル・オーストラリア・米国南部などでも野外結実が確認されています。
...
- **対処**：水やりの間隔を空けて土を乾燥気味に、表土を赤玉土や軽石で 1〜2 cm 程度覆って卵が産み付けられない環境にする
...
- **症状**：**葉が筒状に巻かれて綴じ合わせられ、内部から食害される**。チョウ目の幼虫が糸でシェルターを作っている
- **対処**：巻かれた葉を発見し次第切除して廃棄。成虫は夜行性で照明に誘引されるため、夜間の窓開け閉めに注意

### ヨトウムシ

- **症状**：**夜間に葉に巨大な食い穴**が一晩で現れる。日中は鉢底の隙間や土壌浅層に隠れている大型のチョウ目幼虫
- **対処**：夜間に懐中電灯で捜索して捕殺、または株元への顆粒殺虫剤

⚠️ 殺虫剤を使う場合は、必ず観葉植物に使用可能な製剤を選び、規定濃度を守ってください。室内で使用する場合は換気しながら、ペットや子どもが触れないよう注意します。浸透移行性のオルトラン粒剤等は土壌散布後の灌水でペットが舐めないよう管理を厳重に。

## 主な病害（カビ・細菌性）

害虫だけでなく、カビ（糸状菌）や細菌による感染症もモンステラに発生します。葉面の斑点が広がる場合は、害虫ではなく病害の可能性を疑ってください。

### 炭疽病（カビ性）

- **症状**：葉面に **不整形の黒褐色斑点** が現れ、拡大すると **内側が淡褐色〜灰白色** に乾燥して、最終的に組織が脆くなり穴が開く
- **発生条件**：20〜25°C の高温多湿、窒素過多、散水時の水滴のはね返り
- **対処**：発病葉を即時切除して廃棄。風通しを確保。広範囲ならベンレート系等の殺菌剤を散布

### 斑点細菌病（細菌性）

- **症状**：**葉脈に沿って滲むような黒褐色〜水浸状の不整形シミ斑**。境界が不鮮明で、炭疽病のような同心円状の同調的拡大は示さない
- **発生条件**：高温多湿、剪定ハサミ・手・水滴を介した感染
- **対処**：発病組織を切除、器具を消毒。広範囲なら銅殺菌剤（サンボルドー系）。**カビ用殺菌剤は効きません**

### 葉枯病・葉斑病（カビ性）

- **症状**：主に古い下葉の **葉先・葉縁から黒褐色に枯れ込み**、健全部との境界に黄色の縁取り（ハロー）が形成される
- **発生条件**：風通しの悪さ、排水不良、過剰な水やり、株勢の低下
- **対処**：患部葉を除去、風通しを改善、ベンレート系等の殺菌剤散布

### さび病（カビ性）

- **症状**：葉裏に **オレンジ・黄・黒色の粉状の膨らんだ小斑点**
- **発生条件**：春・秋の多湿、株の過密
- **対処**：病変部位を除去、株間を空ける、薬剤散布

### 感染病害への対処の基本

⚠️ 病害が発生した株を触った手や器具で健全株に触れると、二次感染を広げる原因になります。作業後は必ず**石鹸での手洗いと器具の消毒**を行ってください。

⚠️ 切除した感染組織はビニール袋に密閉して屋外へ廃棄。**コンポストや鉢周辺に放置しない** こと（胞子の飛散源になります）。

📖 IPM（統合的病害虫管理）の基本は「予防 → 監視 → 物理的対処 → 化学防除」の順。最初からの薬剤散布は耐性害虫を生み、観葉植物にも負担をかけるため、まず風通し・灌水管理・葉水観察などの基本管理を見直すことが重要です。
`,
    updatedAt: '2026-05-21',
  },
  {
...
この結晶は植物の組織全体（葉柄・主茎・若い葉）にイディオブラスト（晶胞）と呼ばれる特殊な細胞内に束状に格納されており、噛むと細胞壁が破裂して鋭利な針が口腔粘膜・舌・咽頭に物理的に突き刺さります。猫の口腔粘膜では針が約 1mm の深さまで穿入することが報告されており、粘膜上皮を貫通して激しい神経原性の炎症を引き起こします。さらに、植物に含まれるタンパク分解酵素やキニン・ヒスタミン放出促進物質が複合的に作用し、灼熱感・浮腫・粘膜刺激を惹起します。

不溶性結晶は唾液や胃酸で分解されず、体内に吸収されないため、毒性は局所（口腔・上部消化管）に限定されます。
...
モンステラは不溶性タイプであり、症状は通常 24〜48 時間以内に徐々に減衰します。とはいえ、口腔・喉の痛みと腫れは激しいため、防止策と早期対応は不可欠です。
...
| 禁忌処置 | リスク |
|---|---|
| **食塩水による催吐** | 致命的な高ナトリウム血症、脳浮腫、不可逆的中枢神経障害 |
| **オキシドール（3% 過酸化水素水）による催吐** | 重度の出血性胃炎、食道壊死、誤嚥性肺炎。猫では完全禁忌 |
| **指や異物を喉に挿入して吐かせる** | 既に炎症した粘膜の機械的損傷、急性喉頭浮腫、咬傷事故 |
| **オリーブオイル等の油性物質を飲ませる** | 急性膵炎、致死的な脂質性誤嚥性肺炎 |
| **イペカック（吐根シロップ）の投与** | 致死的徐脈、心室性不整脈、心不全 |
| **大量の牛乳を飲ませる** | 乳糖不耐症による高浸透圧性下痢、急性膵炎 |

⚠️ さらに、サトイモ科の誤食では **「胃から吐かせる」行為自体が原則禁忌** です。鋭利な針状結晶が再度食道・喉頭を通過することで二次擦過傷・粘膜穿孔・誤嚥性肺炎を誘発します。催吐の判断は必ず獣医師に委ねてください。
...
猫の獣医療において、サトイモ科の「○○リリー」と本物のユリ（Lilium 属・Hemerocallis 属）の混同は、**致命的な事故**につながることがあります。

| 名称 | 学名・分類 | 毒性機序 | 予後 |
|---|---|---|---|
| **ピースリリー（スパティフィラム）** | Spathiphyllum、サトイモ科 | 不溶性シュウ酸カルシウム | 局所刺激のみ、予後良好 |
| **カラーリリー** | Zantedeschia、サトイモ科 | 同上 | 同上 |
| **真のユリ・デイリリー** | Lilium / Hemerocallis | 未解明の急性腎毒性 | **猫に致命的、18 時間以内の集中治療が必須** |

⚠️ 猫が「真のユリ」を齧った場合、**18 時間のゴールデンタイム** を過ぎると未治療では急性腎不全で死亡する可能性が高いとされます。「同じシュウ酸塩中毒だろう」と軽視せず、植物の **学名（属名）** を特定して獣医師に速やかに連絡してください。逆に、ピースリリーの誤食を真のユリ並みに重大視して食塩水・オキシドール等で粗暴な催吐を試みると、軽症が重篤化します。

植物名が分からない場合は、**葉や残骸を持参** することが鑑別の決定的な手がかりになります。
